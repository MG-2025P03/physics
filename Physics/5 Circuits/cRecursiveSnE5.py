...
# Initial graph printout and visualization
print("Initial Graph:")
print_graph(G)
...
n = len(graphs)
to_display = set(range(min(5, n)))  # First few graphs
to_display.update(range(max(0, n - 5), n))  # Last few graphs

# Display selected graphs
for i in sorted(to_display):
